    ...
    if (!isset($_SESSION['user_id'])) {
        if (isset($_POST['submit'])) {
            ...
            if (!empty($user_username) && !empty($user_password)) {
                ...
                $query = "SELECT id, username FROM member WHERE username = '$user_username' AND password = SHA('$user_password')";
            ...
            <div class="col-md-6 col-md-offset-3">
                <form action= "<?php echo $_SERVER['PHP_SELF']; ?>"  method="post" required>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control input-lg" placeholder="Username" name="username" size="30" value="<?php if (!empty($user_username)) echo $user_username; ?>" required>
                    </div>
                    <div class="form-group">
